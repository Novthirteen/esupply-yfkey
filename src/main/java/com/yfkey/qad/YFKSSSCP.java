...
public class YFKSSSCP implements SDOFactory
{
               ...
               IOException
    {
        ...
        connection.setIntProperty("PROGRESS.Session.sessionModel", QADConfg.m_SessionModel);
        m_YFKSSSCPImpl = new YFKSSSCPImpl(
                                  "YFKSS_SCP",
                                  connection,
                                  RunTimeProperties.tracer);
    }

    public YFKSSSCP(String urlString,
                        String userId,
                        String password,
               ...
               IOException
    {
        ...
        connection = new Connection("YFKSS_SCP",
                                    userId,
                                    password,
                                    appServerInfo);
